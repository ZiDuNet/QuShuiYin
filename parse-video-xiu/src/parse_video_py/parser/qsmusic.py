"""汽水音乐解析 — 基于 api.bugpk.com 第三方接口（官方接口）

接口地址: https://api.bugpk.com/api/qsmusic
请求方式: GET
请求参数: url (音乐链接) / type (json/down/search/url/lyric)
功能: 汽水音乐解析，提取音乐直链
"""
...
class QsMusic(BaseParser):
    async def parse_share_url(self, share_url: str) -> VideoInfo:
        api_url = f"https://api.bugpk.com/api/qsmusic?url={share_url}"
    ...
    async def parse_video_id(self, video_id: str) -> VideoInfo:
        raise NotImplementedError("汽水音乐解析请使用分享链接")
